...
async function syncFriends() {
    try {
        ...
        // DBに存在しないUUIDは即座に除外（相手が削除した瞬間に消える）
        friendUuids = dbUuids;
        ...
        // もし現在選択中の相手がDBから消えていたら、チャットを強制リセット
...
window.addEventListener('DOMContentLoaded', async () => {
    ...
    setInterval(syncFriends, 5000); // 5秒ごとにDBと強制同期。相手が消せばここで自分からも消える
